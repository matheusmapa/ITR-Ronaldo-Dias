...
const Exclusivo = () => {
    return (
        <section className="py-24 px-6 bg-white relative overflow-hidden">
            {/* Glow Effects */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-100 rounded-full blur-[100px]"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-yellow-100 rounded-full blur-[120px]"></div>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-slate-800 mb-6 flex flex-col md:flex-row items-center justify-center gap-3">
                        ...
                        <motion.span
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: 1.5, type: "spring" }} // O delay deve ser maior que (tamanho_da_string * 0.05) para aparecer depois da digitação
                            className="text-yellow-500 font-black inline-block mt-2 md:mt-0"
                        >
                            Bônus
                        </motion.span>
                    </h2>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-20">
                    <TiltCard className="bg-slate-50 border border-slate-200 p-8 hover:border-yellow-400">
                        <Brain className="w-10 h-10 text-yellow-500 mb-6" />
                        <h3 className="text-xl font-bold text-slate-800 mb-3">Módulo Expansão</h3>
                        <p className="text-slate-600 font-light">Técnicas de memorização testadas em outras áreas.</p>
                    </TiltCard>

                    <TiltCard className="bg-slate-50 border border-slate-200 p-8 hover:border-yellow-400">
                        <Bot className="w-10 h-10 text-yellow-500 mb-6" />
                        <h3 className="text-xl font-bold text-slate-800 mb-3">IA Personalizada</h3>
                        <p className="text-slate-600 font-light">Inteligência Artificial programada para te treinar 24/7.</p>
                    </TiltCard>

                    <TiltCard className="bg-slate-50 border border-slate-200 p-8 hover:border-yellow-400">
                        <Users className="w-10 h-10 text-yellow-500 mb-6" />
                        <h3 className="text-xl font-bold text-slate-800 mb-3">Comunidade VIP</h3>
                        <p className="text-slate-600 font-light">Acesso no WhatsApp para suporte e desafios diários.</p>
                    </TiltCard>
                </div>

                <div className="bg-slate-50 border border-slate-200 p-10 md:p-16 rounded-3xl relative overflow-hidden group">
                    <div className="absolute top-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity">
                        <Plane className="w-64 h-64 text-emerald-500 -translate-y-10 translate-x-10" />
                    </div>

                    <h3 className="text-2xl md:text-3xl font-bold text-slate-800 mb-6 relative z-10 italic">"Feche os olhos e imagine..."</h3>
                    <p className="text-lg md:text-xl text-slate-600 font-light leading-relaxed max-w-3xl relative z-10 italic border-l-4 border-emerald-500 pl-6">
