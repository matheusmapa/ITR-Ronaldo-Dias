...
export function InteractiveGlobe({
    className,
    size = 600,
    dotColor = "rgba(16, 185, 129, ALPHA)", // Changed to match ITR Emerald
    arcColor = "rgba(16, 185, 129, 0.5)",
    markerColor = "rgba(52, 211, 153, 1)", // Teal 400
    ...
    const draw = useCallback(() => {
        ...
        // Configura tamanho real só se for diferente para evitar flickers e vazamentos
        if (canvas.width !== w * dpr) canvas.width = w * dpr;
        if (canvas.height !== h * dpr) canvas.height = h * dpr;

        // Reseta escala antes de aplicar
        ...
        glowGrad.addColorStop(0, "rgba(5, 150, 105, 0.04)");
    ...
    return (
        <canvas
            ...
            style={{ width: "100%", height: "100%", minHeight: size, maxWidth: size }}
